...
MockBloomFilter::MockBloomFilter(size_t size, size_t num_hashes) : m_bit_array(size, false), m_num_hashes{ num_hashes } {};

void MockBloomFilter::insert(const std::string& item) {
...
bool MockBloomFilter::contains(const std::string& item) const {
    for (size_t i = 0; i < m_num_hashes; ++i) {
